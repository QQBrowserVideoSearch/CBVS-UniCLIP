...
'''
from uniclip.training.main import convert_models_to_fp32
...
from uniclip.clip.utils import image_transform
from uniclip.eval.data import get_zeroshot_dataset, _preprocess_text
from uniclip.eval.cvinw_zeroshot_templates import (
    openai_templates,
    flower_templates,
    food_templates,
    aircraft_templates,
...
if __name__ == "__main__":
    ...
    if args.ocr_exist==0 and args.ocr_content==0:
    ...
    # del sd['proj_ocr_exist']
    # del sd['ln_ocr_exist.weight']
    # del sd['ln_ocr_exist.bias']
