...
class CLIP(nn.Module):
    def __init__(self,
        ...
        if self.ocr_presence:
            self.ocr_presence_decoder = Transformer(vision_width, layers=3, heads=vision_heads, use_flash_attention=use_flash_attention)
            self.ln_ocr_presence = LayerNorm(vision_width)
